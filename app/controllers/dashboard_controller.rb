...
class DashboardController < ApplicationController
  ...
  # Earlier users of the service may not have an organisation linked to their
  # user account, or may be missing cruitial org details. 
  # Because of this, we need to check for an organisation and
